  ...
  @foreach($all_lab_info as $v_lab):
      <section class="jumbotron text-center">
        <div class="container">
          ...
          <h1 class="jumbotron-heading">PC {{$v_lab->id}} has Update Request</h1>
          <p class="lead text-muted">Hi,there are some updates in your lab equipments....!</p>

          <p>
            <a href="{{URL::to('/accept_edit/'.$v_lab->id)}}"><button class="btn btn-outline-primary">Accept</button></a>
            <a href="{{URL::to('/reject_edit/'.$v_lab->id)}}"><button class="btn btn-outline-primary">Reject</button></a>
          </p>
